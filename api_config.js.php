...
// Also check for frontend .env file if it exists
$frontendEnvFile = '../system/.env';
$frontendApiUrl = null;

if (file_exists($frontendEnvFile)) {
    $frontendEnv = parse_ini_file($frontendEnvFile);
    if (isset($frontendEnv['API_BASE_URL'])) {
        $frontendApiUrl = rtrim($frontendEnv['API_BASE_URL'], '/');
    }
}

header("Content-Type: application/javascript");
?>
const API_BASE_URL = "<?php echo $frontendApiUrl ?: rtrim($_ENV['API_BASE_URL'], '/'); ?>";
