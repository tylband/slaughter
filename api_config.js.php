...
$systemEnvFile = __DIR__ . '/../system/.env';
$systemApiUrl = null;
...
$configuredApiUrl = $systemApiUrl ?: rtrim($_ENV['API_BASE_URL'] ?? '', '/');
...
if ($configuredApiUrl) {
    ...
    if ($isPrivateConfiguredHost && $requestHost && strcasecmp($configuredHost, $requestHost) !== 0) {
