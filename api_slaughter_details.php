...
try {
    ...
    error_log('API Slaughter Details Session Debug - Username: ' . ($_SESSION['username'] ?? 'NOT SET') . ', UserID: ' . ($_SESSION['user_id'] ?? 'NOT SET'));
...
if ($_SERVER['REQUEST_METHOD'] !== 'OPTIONS') {
    if (!isset($_SESSION['username']) || !isset($_SESSION['user_id'])) {
        ...
        if (isset($_GET['test']) && $_GET['test'] === '1') {
            ...
            $_SESSION['user_id'] = 1;
            error_log('Created test session for API slaughter details debugging');
        } else {
